...
import sys
sys.path.append('./NM4P-master/Python/nm4p/')  #this is required to import a module from outside of the current directory.
...
a2.set_xlabel('t')
a2.set_ylabel('theta_euler - theta_verlet')
plt.tight_layout()
plt.show()	
